...
public slots:
  ...
  ////
  void removePolygonNote2DMark(double* point);
  void openPolygonNote2DMark(double* point);
  void loadPolygonNote2DMark(double* point, const ColorType color, bool isDisplay = false);
  //// TO BE IMPLEMENTED
